...
export default function SidebarAdminCabang() {
 ...
 const menuItems = [
    ...
    { label: 'Pengaturan Hak Akses', path: '/admin-cabang/hak-akses', icon: ShieldCheck },
    ...
    >
        ...
        <div className="p-5 border-b border-gray-200 flex items-center justify-between">
          {!collapsed && (
            <div>
              ...
              <p className="text-xs text-gray-400">Admin Cabang</p>
            </div>
          )}
          <button
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex items-center gap-2">
          ...
          {!collapsed && (
            <div>
              <p className="text-sm font-medium text-gray-700">Admin Cabang</p>
